...
## 注意！
このツールは **bypassPermissions モード** や **full-auto** を利用しているので、意図せず破壊的な動作をAIエージェントが行う可能性があります。
VM環境で行うなどよく注意して、自己責任で使用してください。
...
ただし、本プロジェクトが利用する"Claude Code CLI"や"Codex CLI"の外部ツールはこのライセンスの範囲外です。各ツールの利用規約に従ってください。
